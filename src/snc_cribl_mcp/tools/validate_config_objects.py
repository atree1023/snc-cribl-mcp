...
def register(app: FastMCP, *, impl: ValidateResourceSyncFunc) -> None:
    ...
    @app.tool(
        ...
        description=(
            "Semantically compare groups, sources, destinations, pipelines, or routes between two configured Cribl leaders. "
            "Expected environment identity differences such as hostnames, endpoint lists, generated IDs, and volatile metadata "
            "are reported but do not count as functional drift."
        ),
        annotations={
